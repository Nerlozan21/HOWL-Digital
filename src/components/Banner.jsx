  ...
  return (
    <div className="cmpt1-cntr">
      <div className="banner-txt-cntr">
        ...
        <img src="../assets/homet-banner-tda-scaled--300x104.png" alt="" srcset="" className="bnr-img" loading='lazy'/>
      ...
      <div className="img-cntr">
        <img src="../assets/homeimg-1.jpg" alt="qwewe" className="banner-img1" loading='lazy'/>
        <img src="../assets/homeimg-2.jpg" alt="dasd" className="banner-img2" loading='lazy'/>
      </div>
    </div>
  );
};
